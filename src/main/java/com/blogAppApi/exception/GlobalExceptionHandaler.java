...
public class GlobalExceptionHandaler {
	...
	public ResponseEntity<ApiResponce> resorceNotFoundException(ResorceNotFoundException ex) {
	...
	public ResponseEntity<Map<String,String>> handalerMethodArgNotValidException(MethodArgumentNotValidException ex){
